...
urlpatterns = [
    # APIs para AJAX
    path('api/palabras-capturadas/', views.palabras_capturadas, name='palabras_capturadas'),
    ...
    # Acciones
    path('eliminar-gesto/<int:palabra_id>/', views.eliminar_gesto, name='eliminar_gesto'),
]